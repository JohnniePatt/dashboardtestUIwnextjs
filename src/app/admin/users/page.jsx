                ...
                <div className='p-10'>
                    ...
                    <table className='text-left rounded-md mt-3 table-fixed w-full'>
                        ...
                        <tbody>
                            <tr>
                                <td className='p-5'>@!##$$%%</td>
                                <td className='p-5'>Jay</td>
                                <td className='p-5'>Jay@gmail.com</td>
                                <td className='p-5'>12312312121</td>
                                <td className='p-5'>
                                    <Link className='bg-gray-500 text-white border py-2 px-3 rounded text-xl my-2' href="/admin/users/edit">Edit</Link>
                                    <Link className='bg-red-500 text-white border py-2 px-3 rounded text-xl my-2' href="/admin/users/delete">Delete</Link>
                                </td>
                            </tr>
                        </tbody>
                    </table>
